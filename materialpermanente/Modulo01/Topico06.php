                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <h2 class="Titulo">Tópico 06 - ATRIBUIÇÕES BÁSICAS DA GESTÃO DE MATERIAL PERMAENTE:</h2>

                            <br>

                            <p class="Texto"><strong>Objetivo:</strong> Compreender o processo de gestão de material permanente no tocante ao controle interno, movimentação até o desfazimento dos bens. </p>

                            

                            <p class="Texto">O almoxarifado, tanto nas entidades públicas como privadas, é o setor que centraliza a responsabilidade pelo recebimento, pela estocagem e distribuição dos materiais de consumo e bens de uso permanente, sendo importante elo da gestão de materiais, sua importância organização e preservação daquilo que é necessário à execução das atividades de cada setor da entidade.</p>

                            <p class="Texto">Sendo assim o processo de gestão patrimonial inicia-se no recebimento do material permanente que ocorre no almoxarifado. </p>
                            
                            <!-- Sub Título -->
                            <p class="SubTitulo">06.1 - Recebimento de materiais e bens:</p>
                            <hr>
                            
                            <p class="Texto">O recebimento de materiais é um importante ponto de controle para avaliação da qualidade de atendimento dos fornecedores, no tocante a prazo, qualidade e volume de pedido. Em termos práticos o processo de recebimento de materiais e bens pode ser subdividido em 3 atividades: agendamento de recebimento, recebimento de materiais e bens e regularização do recebimento. </p>

                            <!-- Sub Sub Título -->
                            <p class="SubSubTitulo">06.1.1 - Agenda de recebimento:</p>
                            <hr>

                            <p class="Texto">Toda e qualquer atividade mesmo a mais simples que possa parecer é mais bem executada quando é antecipadamente planejada. O recebimento de materiais é um ponto crítico de controle por que é o momento em que a entidade atesta o aceite dos materiais que foram pedidos ao fornecedor e a partir deste aceite será efetuado o pagamento ao mesmo.
                            ...
                            <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="Item01" data-bs-parent="#AccordionFase01">
                                            <div class="accordion-body">
                                                <p><strong>Recebimento Provisório:</strong> O material adquirido é entregue à entidade no local definido, não implicando necessariamente em aceitação. Nesse momento serão realizados procedimentos de conferência para aceitar ou não a carga. </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item Texto">
                                        ...
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="Item02" data-bs-parent="#AccordionFase01">
                                            <div class="accordion-body">
                                                <p><strong>Recebimento Definitivo:</strong> Ato por meio do qual se declara, na documentação fiscal, que o material recebido está de acordo com as especificações do Pedido de Fornecimento. 
                                                <br><br>O objetivo de se realizar o recebimento de materiais da forma sistematizada é assegurar que o material entregue esteja em conformidade com as especificações constantes no contrato e/ou no Pedido de Fornecimento ou documento equivalente.
                                                ...
                                                <br><br>As atribuições básicas durante o recebimento de materiais são:    
                                                </p>

                                                <p class="Texto"><strong>1 - Recepcionar os veículos de transportadores</strong></p>
                                                <hr>

                                                <p>A recepção dos veículos transportadores representa o início do processo de recebimento que tem como objetivos:</p>

                                                <ul>
                                                    <i class="fa fa-check-circle CorVerdeClaroEstado"></i> Controlar a entrada dos veículos transportadores nas dependências da organização;</li>
                                                    <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Efetuar a triagem da documentação suporte para o recebimento;</li>
                                                    <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Constatar se o fornecimento, objeto da Nota Fiscal em análise, foi programado na Agenda de Recebimento e se está dentro do prazo de entrega contratual;</li>
                                                    <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Constatar se o número do Pedido de Fornecimento consta na Nota Fiscal;</li>
                                                    <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Atualizar a Agenda de Recebimento com as informações referentes aos descarregamentos autorizados.</li>   
                                                </ul>
                                                ...
                                                <br><p class="Texto"><strong>2 - Proceder a conferência visual</strong></p>
                                                <hr>
                                                ...
                                                <br><br>Os materiais que passaram por essa primeira etapa devem ser encaminhados ao Almoxarifado. Para efeito de descarga do material no Almoxarifado, a recepção é voltada apenas para a conferência de volumes, confrontando-se a Nota Fiscal com os respectivos registros na Agenda de Recebimento.
                                                </p>

                                                <br><p class="Texto"><strong>3 - Proceder a conferência quantitativa e qualitativa dos materiais recebidos </strong></p>
                                                <hr>

                                                <p><strong>Conferência quantitativa:</strong> verificação se a quantidade declarada pelo fornecedor na nota fiscal corresponde efetivamente à quantidade fisicamente recebida, podendo ser realizada de duas formas a saber:        
                                                <br><br>

                                                <!-- CAIXA AZUL -->
                                                <div class="bd-callout bd-callout-primary">
                                                    <p>
                                                    <i class="fa fa-arrow-right CorVerdeClaroEstado"></i><strong> Pelo volume total da entrega:</strong> quando a carga é averiguada em sua integralidade, contabilizando-se todos os itens que foram entregues. Pode ser realizada de duas maneiras:
                                                    </p>

                                                    <ul>
                                                        <i class="fa fa-angle-double-right CorVerdeClaroEstado"></i> O conferente verifica a nota fiscal e, sabendo dos quantitativos dos materiais, faz a contagem da carga para apurar possíveis desvios;</li>
                                                        ...
                                                        <br>Sendo ou não a “contagem cega”, dependendo da natureza dos materiais envolvidos, estes podem ser contados utilizando-se também outros métodos, tais como:
                                                        </li>

                                                        <ul>
                                                            <i class="fa fa-angle-right CorVerdeClaroEstado"></i> <strong>Manual:</strong> para casos de pequenas quantidades. </li>
                                                            <br><i class="fa fa-angle-right CorVerdeClaroEstado"></i> <strong>Por meio de cálculo:</strong> para os casos que envolvem embalagens padronizadas com grandes quantidades.</li>
                                                            <br><i class="fa fa-angle-right CorVerdeClaroEstado"></i> <strong>Por meio de balanças contadoras:</strong> para casos que envolvem grande quantidade de pequenas peças, como parafusos, porcas ou arruelas.</li>
                                                            <br><i class="fa fa-angle-right CorVerdeClaroEstado"></i> <strong>Medição:</strong> em geral, as medições são efetuadas por meio de trenas.</li>
                                                        </ul>
                                                    </ul>
                                                </div>
                                                <!-- FIM CAIXA AZUL -->
                                                ...
                                                <div class="bd-callout bd-callout-primary">
                                                    <p>
                                                    <i class="fa fa-arrow-right CorVerdeClaroEstado"></i><strong> Por amostragem da carga:</strong> do quantitativo declarado na nota fiscal é definido um percentual de cada item que será objeto de verificação para apuração de possíveis desvios. 
                                                    <br><br> A escolha do método para a conferência quantitativa, seja pelo total da carga ou por amostragem, será decisão do responsável pelo almoxarifado, no entanto sempre deverá estar especificado na Nota Fiscal do recebimento o método pelo qual foi efetuada a conferência.
                                                    </p>
                                                ...
                                                <p><strong>Conferência qualitativa:</strong> é a inspeção técnica de qualidade do material por meio da confrontação das condições contratadas no Pedido de Fornecimento com as consignadas na Nota Fiscal pelo fornecedor. Essa análise visa garantir o recebimento adequado do material contratado por meio do exame de suas características dimensionais, específicas e restrições de especificação. O objetivo é garantir a adequação do material ao fim que se destina. São utilizados no processo de inspeção: </p>

                                                <ul>
                                                    <i class="fa fa-check-circle CorVerdeClaroEstado"></i> A especificação de compra do material e alternativas aprovadas; desenhos e catálogos técnicos; dentre outros. </li>
                                                    <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> A análise visual que tem por finalidade verificar o acabamento do material, possíveis defeitos, danos à pintura, etc. </li>
                                                    <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> A análise dimensional que tem por objetivo verificar as dimensões dos materiais, tais como largura, comprimento, altura, espessura, diâmetro. </li>
                                                    <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Os ensaios específicos para materiais mecânicos e elétricos comprovam a qualidade, a resistência mecânica, o balanceamento e o desempenho de materiais ou equipamentos. </li>                                                    
                                                </ul>

                                                <p>A depender da quantidade, a inspeção pode ser total ou por amostragem, utilizando-se de conceitos estatísticos.</p>

                                                <br><p><strong>4 - Decidir pela recusa, aceite ou devolução, conforme o caso; </strong></p>
                                                <hr>
                                    ...
                                    <ul class="Texto">
                                        <i class="fa fa-check-circle CorVerdeClaroEstado"></i> Liberação de pagamento ao fornecedor;</li>
                                        <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Liberação parcial de pagamento ao fornecedor;</li>
                                        <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Devolução de material ao fornecedor;</li>
                                        <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Recusa do recebimento;</li>
                                        <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Reclamação de falta do fornecedor junto ao órgão/unidade gestora de compras.</li>
                                    </ul>
                                    ...
                                    <ul class="Texto">
                                        <i class="fa fa-check-circle CorVerdeClaroEstado"></i> Nota Fiscal; </li>
                                        <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Conhecimento de transporte rodoviário de carga;</li>
                                        <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Documento de contagem efetuada;</li>
                                        <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Relatório técnico de inspeção de recebimento;</li>
                                        <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Especificação de compra;</li>
                                        <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Catálogos técnicos;</li>
                                        <br><i class="fa fa-check-circle CorVerdeClaroEstado"></i> Desenhos.</li>
                                    </ul>
