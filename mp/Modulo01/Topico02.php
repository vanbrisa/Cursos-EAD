    ...
    <?php include('layout/menu.php') ?>
        ...
        <div id="main">
            ...
            <div class="main-content container-fluid Texto">
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <h2 class="Titulo">02 - O reflexo das Novas Normas Contábeis no controle patrimonial</h2>

                            <br><p><strong>Objetivo:</strong> Compreender os conceitos introduzidos pelas Normas Brasileiras de Contabilidade Aplicadas ao Setor Público – NBCASP referentes à mensuração e avaliação do patrimônio público, assim como a mecânica do cálculo da depreciação. </p>
                            ...
                            <div class="text-center">
                                <a href="imagens/Figura001.png" data-bs-toggle="modal" data-bs-target="#Imagem001">
                            ...
                            <br><p>As primeiras Novas Normas Contábeis editadas pelo Conselho Federal de Contabilidade denominada “NBC T 16”, trouxeram alguns conceitos que passaram a ser considerados nos procedimentos administrativos de controle patrimonial que passaram a incorporá-los de forma que as variações patrimoniais possam ser mais bem apuradas e reflitam na Contabilidade ao fim de cada exercício financeiro, são estes: </p>

                            <!-- Importante -->
                            <div class="ImportanteCaixa">
                                <p class="ImportanteTitulo"> Importante</p>
                                <p class="ImportanteTexto">
                                    <i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Depreciação: </strong>a redução do valor dos bens tangíveis pelo desgaste ou perda de utilidade por uso, ação da natureza ou obsolescência.
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Valor bruto contábil: </strong>o valor do bem registrado no controle escritural, em uma determinada data, sem a dedução da correspondente depreciação acumulada. 
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Valor líquido contábil: </strong>o valor do bem registrado no controle escritural, em determinada data, deduzido da correspondente depreciação acumulada. 
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Valor depreciável: </strong>o valor original de um bem deduzido do seu valor residual.
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Valor residual: </strong>o montante líquido que a entidade espera, com razoável segurança, obter por um bem no fim de sua vida útil econômica, deduzidos os gastos esperados para sua alienação.
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Vida útil econômica: </strong>o período de tempo definido ou estimado tecnicamente, durante o qual se espera obter fluxos de benefícios futuros de um bem. 
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Avaliação patrimonial: </strong>a atribuição de valor monetário a itens do ativo e do passivos decorrentes de julgamento fundamentado em consenso entre as partes e que traduza, com razoabilidade, a evidenciação dos atos e dos fatos administrativos. 
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Reavaliação: </strong>a adoção do valor de mercado ou de consenso entre as partes para bens do ativo, quando esse for diferente do valor líquido contábil.
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Redução ao valor recuperável <em>(impairment)</em>: </strong>é a redução nos benefícios econômicos futuros ou no potencial de serviços de um bem do ativo que reflete o declínio na sua utilidade, além do reconhecimento sistemático por meio da depreciação. 
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Valor recuperável: </strong> o valor de mercado de um ativo menos o custo para a sua alienação, ou o valor que a entidade do setor público espera recuperar pelo uso futuro desse ativo nas suas operações, o que for maior. 
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Valor de aquisição: </strong>a soma do preço de compra de um bem com os gastos suportados direta ou indiretamente para colocá-lo em condição de uso. 
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Valor justo: </strong>é o preço que seria recebido pela venda de um ativo ou que seria pago pela transferência de um passivo em uma transação não forçada entre participantes do mercado na data de mensuração.
                                    <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> <strong>Valor realizável líquido: </strong>a quantia que a entidade do setor público espera obter com a alienação ou a utilização de itens de inventário quando deduzidos os gastos estimados para seu acabamento, alienação ou utilização. 
                                </p> 
                            </div>

                            <br><p>A partir dos referidos conceitos apresentados pelas Novas Normas Contábeis, os procedimentos administrativos de controle patrimonial, passaram também a incorporar regras de mensuração que permitam traduzir em moeda corrente o valor econômico dos bens. Tais regras são as seguintes:</p>
                                ...
                                <p class="Texto">
                                    <ol>
                                        ...
                                        <li>Para o registro da depreciação dos bens devem ser observados os seguintes aspectos:</li>
                                            <ul>
                                                <i class="fa fa-dot-circle CorVerdeClaroEstado"></i> obrigatoriedade do seu reconhecimento;
                                                <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> valor da parcela que deve ser reconhecida no resultado como decréscimo patrimonial, e, no balanço patrimonial, representada em conta redutora do respectivo ativo;
                                                <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> circunstâncias que podem influenciar seu registro.
                                            </ul>
                                        ...
                                        <li>Os seguintes fatores devem ser considerados ao se estimar a vida útil econômica de um bem:</li>
                                            <ul>
                                                <i class="fa fa-dot-circle CorVerdeClaroEstado"></i> A capacidade de geração de benefícios futuros;
                                                <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> O desgaste físico decorrente de fatores operacionais ou não;
                                                <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> A obsolescência tecnológica;
                                                <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> Os limites legais ou contratuais sobre o uso ou a exploração do ativo.
                                            </ul>
                                        ...
                                        <li>Não estão sujeitos ao regime de depreciação:</li>
                                            <ul>
                                                <i class="fa fa-dot-circle CorVerdeClaroEstado"></i> Bens móveis de natureza cultural, tais como obras de artes, antiguidades, documentos, bens com interesse histórico, bens integrados em coleções, entre outros;
                                                <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> Bens de uso comum que absorveram ou absorvem recursos públicos, considerados tecnicamente, de vida útil indeterminada;
                                                <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> Animais que se destinam à exposição e à preservação;
                                                <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> Terrenos rurais e urbanos.
                                            </ul>
                                        <li>Os métodos de depreciação, amortização e exaustão devem ser compatíveis com a vida útil econômica do ativo e aplicados uniformemente. </li>
                                            <ul>
                                                <i class="fa fa-dot-circle CorVerdeClaroEstado"></i> Sem prejuízo da utilização de outros métodos de cálculo dos encargos de depreciação, podem ser adotados: o método das quotas constantes; o método das somas dos dígitos; o método das unidades produzidas.
                                                <br><i class="fa fa-dot-circle CorVerdeClaroEstado"></i> A depreciação de bens imóveis deve ser calculada com base, exclusivamente, no custo de construção, deduzido o valor dos terrenos.
                                            </ul>
                                    </ol>
                                </p>
                            </div>
                            ...
                            <!-- Imagem 002 - MODAL -->
                            <div class="modal fade text-center" id="Imagem002" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <img class="img-fluid" src="imagens/Figura002.png" alt="Alt da imagem fica aqui">
                ...
                <!-- Botões de navegação -->
                <div class="text-center">
                    <a href="Topico01.3.php" class="btn btn-outline-success" role="button" aria-pressed="true"><i class="fa fa-chevron-left"></i> Voltar</a>
