                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <h2 class="Titulo">5.3) Estrutura básica de um catálogo de bens, materiais e serviços:</h2>
                            ...
                            <ol>
                                <li>Nível 0 – Categoria: Subdivida em Material de Consumo, Material Permanente e Serviço.</li>
                                <li>Nível 1 – Grupo: Estabelece a classificação das categorias.</li>
                                <li>Nível 2 – Classe: Subdivisão do grupo segundo a sua natureza.</li>
                                <li>Nível 3 – Material: Descrição genérica do material/serviço sem caracterização.</li>
                                <li>Nível 4 – Item de Material: Especificação do item contendo todas as características de individualização e identificação.</li>
                            </ol>
                            ...
                            <p>Decreto Estadual <strong>Nº 32.901</strong> de 17/12/2018, que regulamenta no âmbito da administração pública estadual direta e indireta, o sistema logístico de suprimentos e dá outras providências, em seu CAPÍTULO V DO CATÁLOGO DE BENS, MATERIAIS E SERVIÇOS estabelece o seguinte:</p>

                            <br><center><strong><h4>CAPÍTULO V DO CATÁLOGO DE BENS, MATERIAIS E SERVIÇOS</h4></strong></center>
                            ...
                            <p>Parágrafo único. Os Órgãos da Administração Pública Estadual Direta, Fundos Especiais, Autarquias, Fundações, Empresas Públicas, Sociedades de Economia Mista e demais entidades controladas direta ou indiretamente pelo Estado, inclusive a Central de Licitações, deverão, obrigatoriamente, utilizar o Catálogo de Bens, Materiais e Serviços do Estado para fazer uso dos itens nas licitações, contratações diretas, chamadas públicas e aquisições por registro de preços.</p>
